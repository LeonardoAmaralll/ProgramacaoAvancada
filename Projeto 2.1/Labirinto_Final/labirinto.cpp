...
void Noh::CustoFut(Coord& Dest)
{
    double deltay(abs(Dest.lin - pos.lin));
    double deltax(abs(Dest.col - pos.col));
    h = (sqrt(2.0) * min(deltax, deltay) + abs(deltay - deltax));
}
