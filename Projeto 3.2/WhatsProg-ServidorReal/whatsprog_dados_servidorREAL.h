...
private:
  ...
  ************************************************************************************** */
  ...
  list<Usuario>::iterator US;
  list<Usuario>::iterator US2;
  list<Usuario>::iterator US3;
  list<Usuario>::iterator NEWUSER;
  list<Usuario>::iterator USEREAD;
  list<Usuario>::iterator USQ;
  list<Usuario>::iterator USS;
  ...
  list<Mensagem>::iterator ME;
  list<Mensagem>::iterator ME1;
  list<Mensagem>::iterator ME2;
  ...
  ************************************************************************************** */
  ...
  void enviarConfirmacoesParaUsuario(Usuario user);
  /* Fim da parte que ***NAO*** pode ser adaptada para o servidor real ***************** */
